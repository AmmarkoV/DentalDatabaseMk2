...
enddate:=cal_q.before_days+i;
  ...
  if enddate>Calender_Function(31,12,datesnstuff[4],0) then MessageBox (0, '� ���������� ������ ��� ������ ��� ��� ������ ��������� ������ ��� ��� ������� ��������� �� ���� ��� ��������� ������..'+#10+'� ��������� �� ��������������� ����� �� ����� ��� ��������� ������.. ', '�������� ��� ��������� ������..', 0 + MB_ICONASTERISK);
...
include_object('window1','window','������ ������ ��� ��������.. ','no','','',wnx1,wny1,wnx2,wny2+20);
draw_all;
delete_object('window1','name'); 

wnx1:=wnx1+40;
wny1:=wny1+55;
include_object('usercomm','comment','����� ������ : ','no','','',wnx1,wny1,0,0); 
...
include_object('protimisi1_com','comment','��� �� ������� �������� �� �������� : ','no','','',wnx1,Y2(last_object)+18,0,0);
include_object('prot_1','checkbox','1','no','','',X2(last_object)+5,Y1(last_object)-3,0,0);
include_object('protimisi2_com','comment','��� �� ������� �������� �� �������� : ','no','','',wnx1,Y2(last_object)+7,0,0);
include_object('prot_2','checkbox','1','no','','',X2(last_object)+5,Y1(last_object)-3,0,0);
include_object('protimisi3_com','comment','����� �������� �� ����o� ������ : ','no','','',wnx1,Y2(last_object)+7,0,0);
include_object('prot_3','checkbox','1','no','','',X2(last_object)+5,Y1(last_object)-3,0,0);
include_object('protimisi4_com','comment','����� �������� �� ����o� ������ : ','no','','',wnx1,Y2(last_object)+7,0,0);
include_object('prot_4','checkbox','1','no','','',X2(last_object)+5,Y1(last_object)-3,0,0);
include_object('protimisie_com','comment','������� , ����� ������ ���������� : ','no','','',wnx1,Y2(last_object)+7,0,0);
include_object('prot_e','checkbox','1','no','','',X2(last_object)+5,Y1(last_object)-3,0,0);

include_object('keno_com','comment','��������� ���� �������� : ','no','','',wnx1,Y2(last_object)+10,0,0);
include_object('keno','textbox','2','no','','',X2(last_object)+5,Y1(last_object)-3,X2(last_object)+35,0);
include_object('keno_com2','comment',' ����� ','no','','',X2(last_object)+5,Y1(last_object)+3,0,0);

include_object('yper_com','comment','��������� ��� : ','no','','',wnx1,Y2(last_object)+14,0,0);
include_object('yperorira','textbox','10','no','','',X2(last_object)+5,Y1(last_object)-3,X2(last_object)+35,0);
include_object('yper_com2','comment',' ����� ��� �����','no','','',X2(last_object)+5,Y1(last_object)+3,0,0);
                                                              //wnx1+30,wny1+40,wnx2-30,wny2-30
include_object('bord1','border','����������� �������','no','','',wnx1-10,wny1-15,wnx2-30,Y2(last_object)+10);

include_object('bord2','border','����������� ������','no','','',wnx1-10,Y2(last_object)+15,wnx2-30,wny2-30);
include_object('days','comment',' �   �   �   �   �   �   �','no','','',wnx1-10+5,Y1(last_object)+8,0,0);
...
include_object('from_c','comment','��� : ','no','','',X2(last_object)+30,Y1(last_object)-10,0,0);
...
include_object('to_c','comment','��� : ','no','','',X1('from_c'),Y2(last_object)+10,0,0);
...
include_object('duration_c','comment','�������� : ','no','','',X1('monday'),Y2('monday')+10,0,0);
include_object('duration','textbox','','no','','',X2(last_object)+2,Y1(last_object),X2(last_object)+32,0);
include_object('duration_c2','comment',' ����� ','no','','',X2(last_object)+5,Y1(last_object),0,0);

include_object('fromday_c','comment','���','no','','',X1('monday'),Y2('duration')+16,0,0);
include_object('fromday','textbox','','no','','',X2(last_object)+5,Y1(last_object)-3,X2(last_object)+45,0);
include_object('fromday_c2','comment',' ��� ��� ','no','','',X2(last_object)+5,Y1(last_object)+3,0,0);
include_object('today','textbox','','no','','',X2(last_object)+5,Y1(last_object)-3,X2(last_object)+45,0);
include_object('fromday_c3','comment','������ ��� ����','no','','',X2(last_object)+5,Y1(last_object)+3,0,0);


include_object('ok','buttonc','OK','no','','',GridX(1,3)+30,Y2('bord2')+10,0,0);
include_object('exit','buttonc','������','no','','',X2(last_object)+10,Y1(last_object),0,0);
draw_all;
...
repeat
 ...
 if get_object_data('ok')='4' then begin
                                    set_button('ok',0);
                                    MessageBox (0, '� ���������� ����� ��� ��������� !' , ' ', 0 + MB_ICONASTERISK);
...
include_object('window1','window','������ ������ ��� ��������.. ','no','','',borderx,bordery,borderx+640,bordery+480);
draw_all;
delete_object('window1','name'); 
